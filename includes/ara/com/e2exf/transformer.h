...
{
public:
    /// @brief Represents correct result of E2E check (machine state is "Valid", check status is "Ok")
    static const E2EResult correctResult;
    ...
    E2EResult CheckOutOfPlace(const DataIdentifier id,
    ...
    ///
    /// @return Result object containing state and check status
    E2EResult Check(const DataIdentifier id, const apd::crc::Buffer& buffer);
