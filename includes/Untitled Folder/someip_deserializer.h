...
#ifndef ARA_COM_INTERNAL_BINDING_SOMEIP_SOMEIP_DESERIALIZER_H_
#define ARA_COM_INTERNAL_BINDING_SOMEIP_SOMEIP_DESERIALIZER_H_
...
class SomeipDeserializer : public Deserializer
{
public:
    using PROPS_TYPE = std::shared_ptr<ApSomeipTransformationProps>;
    
    SomeipDeserializer(const uint8_t *data, uint32_t size, std::shared_ptr<ApSomeipTransformationProps> transformationProps);
    virtual ~SomeipDeserializer();
...
#endif  // ARA_COM_INTERNAL_BINDING_SOMEIP_SOMEIP_DESERIALIZER_H_
