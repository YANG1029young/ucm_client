...
public:
    ...
    static constexpr uint32_t startValueCrc32P4{0xFF'FF'FF'FFU};

    /// @brief initial value for CRC32-calculation
    static constexpr uint32_t startValueCrc32{0xFF'FF'FF'FFU};
    ...
    static constexpr uint64_t startValueCrc64{0xFF'FF'FF'FF'FF'FF'FF'FFU};
...
private:
    ...
    static constexpr uint32_t xorValueCrc32P4{0xFF'FF'FF'FFU};
    static constexpr uint32_t xorValueCrc32{0xFF'FF'FF'FFU};
    static constexpr uint16_t xorValueCrc16{0x00'00U};
    static constexpr uint64_t xorValueCrc64{0xFF'FF'FF'FF'FF'FF'FF'FFU};
