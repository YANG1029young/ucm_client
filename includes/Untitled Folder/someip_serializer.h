...
#ifndef ARA_COM_INTERNAL_BINDING_SOMEIP_SOMEIP_SERIALIZER_H_
#define ARA_COM_INTERNAL_BINDING_SOMEIP_SOMEIP_SERIALIZER_H_
...
class SomeipSerializer : public Serializer
{
public:
    SomeipSerializer(std::shared_ptr<ApSomeipTransformationProps> transformationProps);
    virtual ~SomeipSerializer();
...
#endif  // ARA_COM_INTERNAL_BINDING_SOMEIP_SOMEIP_SERIALIZER_H_
